...
# TIERED giveback by peak band (08-27): loose early so runners aren't choked, tight once it's a big winner
GEX_TRAIL_BAND_MID=0.50        # low→mid edge
GEX_TRAIL_BAND_HIGH=0.70       # mid→high edge
